...
data_file = open(r'D:\Isi School Project\Backend\Api\intents.json', encoding='utf-8').read()
...
intents = json.loads(open(r"D:\Isi School Project\Backend\Api\intents.json", encoding='utf-8').read())
